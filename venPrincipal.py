...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.gridLayout.addWidget(self.cmbMunicli, 6, 11, 1, 3)
        ...
        self.date_lbl.setMinimumSize(QtCore.QSize(70, 20))
        self.date_lbl.setMaximumSize(QtCore.QSize(60, 20))
        ...
        self.gridLayout.addItem(spacerItem5, 6, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.txtDircli, 6, 1, 1, 4)
        ...
        self.lblApelcli.setMinimumSize(QtCore.QSize(50, 20))
        self.lblApelcli.setMaximumSize(QtCore.QSize(50, 20))
        ...
        self.lblEmailCli.setMinimumSize(QtCore.QSize(50, 20))
        self.lblEmailCli.setMaximumSize(QtCore.QSize(50, 20))
        ...
        self.lblMovilcli.setMinimumSize(QtCore.QSize(60, 20))
        self.lblMovilcli.setMaximumSize(QtCore.QSize(60, 20))
        ...
        self.lblDircli.setMinimumSize(QtCore.QSize(50, 20))
        self.lblDircli.setMaximumSize(QtCore.QSize(50, 20))
        ...
        self.gridLayout.addWidget(self.cmbProcli, 6, 7, 1, 1)
        self.lblProcli = QtWidgets.QLabel(parent=self.pesClientes)
        self.lblProcli.setObjectName("lblProcli")
        self.gridLayout.addWidget(self.lblProcli, 6, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.txtMovilcli, 4, 4, 1, 4)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(20, 6, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        self.gridLayout.addItem(spacerItem9, 3, 13, 1, 1)
        spacerItem10 = QtWidgets.QSpacerItem(20, 6, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        self.gridLayout.addItem(spacerItem10, 5, 13, 1, 1)
        ...
        self.lblNomcli.setMinimumSize(QtCore.QSize(60, 20))
        self.lblNomcli.setMaximumSize(QtCore.QSize(60, 20))
